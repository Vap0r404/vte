...
if ($Target -eq 'vte') {
    $src = @(Join-Path -Path $PSScriptRoot -ChildPath "src\editor_curses.c"), (Join-Path -Path $PSScriptRoot -ChildPath "src\modules\line_edit.c"), (Join-Path -Path $PSScriptRoot -ChildPath "src\modules\buffer.c"), (Join-Path -Path $PSScriptRoot -ChildPath "src\modules\syntax.c")
